...
class CarController extends AbstractController
{
    ...
    #[Route('/cars/{id}', name: 'app_car_details')]
    public function details(int $id, CarRepository $carRepository, ReviewRepository $reviewRepository): Response
    {
        ...
        $reviews = $reviewRepository->findBy(['car' => $car], ['createdAt' => 'DESC']);
    ...
    #[Route('/cars/{id}/review/new', name: 'app_add_review', methods: ['GET', 'POST'])]
    public function addReview(int $id, Request $request, EntityManagerInterface $entityManager, CarRepository $carRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_car_details', ['id' => $id]);
        }
